      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link
              to="/pricing"
              className="text-gray-700 hover:text-green-500 font-semibold transition-colors flex items-center gap-1"
            >
              Pricing
            </Link>
                    ...
                    {user?.role === "farmer" && (
                      <>
                        ...
                        <Link
                          ...
                          className="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-500 font-medium"
                          onClick={() => setIsProfileOpen(false)}
                        >
                          SaaS Plan & Upgrade
                        </Link>
