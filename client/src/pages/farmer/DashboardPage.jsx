...
const DashboardPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* SaaS Membership Banner */}
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-2xl p-6 mb-8 shadow-lg flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
          <span className="bg-green-500/40 text-green-100 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            SaaS Plan Status
          </span>
          <h2 className="text-2xl font-bold mt-2 flex items-center gap-2">
            Agri-Tech Digital Marketplace Tier
          </h2>
          <p className="text-green-100 text-sm mt-1">
            Unlimited produce listing, verified farmer trust badge, and direct sales analytics.
          </p>
        </div>
        <Link
          to="/farmer/subscription"
          className="bg-white text-green-700 font-bold px-6 py-3 rounded-xl hover:bg-green-50 transition-colors shadow-md whitespace-nowrap"
        >
          Manage Plan & Upgrade
        </Link>
      </div>
